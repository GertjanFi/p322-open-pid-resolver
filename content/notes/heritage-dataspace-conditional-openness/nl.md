...
[Je vindt de vorige experimenten in de P-322 Github dataspace-experiments repository](https://github.com/p-322/dataspace-experiments).
...
>
> Misschien gaat een dataspace daarom wel over het weerbaar maken van open infrastructuur.
...
Elders in de (semi)publieke sector zijn organisaties te vinden die de aan hun toevertrouwde data en infrastructuur uitbaten om zo een deel van hun kosten dekken: het [Kadaster](https://www.kadaster.nl), de [Kamer van Koophandel](https://www.kvk.nl), [Logius](https://www.logius.nl). en [SURF](https://www.surf.nl) zijn daar voorbeelden van.
...
Het is vast niemand ontgaan dat er nogal wat te doen is over het [Centraal Archief Bijzondere Rechtspleging (CABR)](https://www.nationaalarchief.nl/onderzoeken/zoekhulpen/centraal-archief-bijzondere-rechtspleging-cabr) dat bij het Nationaal Archief in Den Haag ligt. Het CABR bevat de dossiers van mensen die na de Tweede Wereldoorlog zijn onderzocht op beschuldiging van collaboratie.
...
De [Autoriteit Persoonsgegevens gaf daarom een formele waarschuwing](https://www.autoriteitpersoonsgegevens.nl/documenten/formele-waarschuwing-nationaal-archief) aan het de minister en het Nationaal Archief om de geplande online publicatie van de dossiers niet door te zetten. Daardoor moest het archief het lange pad inzetten: de demissionaire minister van OCW probeert [nu een wijziging in de archiefwet door de kamer te loodsen](https://nos.nl/artikel/2599380-kabinet-oorlogsarchief-zo-snel-mogelijk-digitaal-te-raadplegen) zodat publicatie van het CABR toch mogelijk wordt.
...
Je kunt ook niet zeggen dat het tegen de wetenschappelijke FAIR-principes (_Findable_, _Accessible_, _Interoperable_ en _Reusable_) in gaat. FAIR zegt namelijk niet zoveel over open. FAIR gaat over hoe data technisch goed beheerd zijn.
...
>
> - Europese Commissie, Open Science beleid ([link](https://rea.ec.europa.eu/open-science_en))
...
Wat George Orwell over dieren schreef: "_All animals are equal, but some animals are more equal than others_", geldt ook voor gebruikers. Niet alle gebruikers zijn gelijk.
...
**Maar _over-my-dead-body_:** een big tech gigant met de jaaromzet van om en nabij een middelgrote Europese economie die AI komt trainen.
